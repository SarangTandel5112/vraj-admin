        ...
        <div className="flex py-6 -mx-6 -my-6 text-[#2A4F67]">
          <div className="w-2/3 px-6 py-6 -my-6 flex flex-col">
            <div className="flex py-6 -mx-6 -my-6">
              <div className="w-1/2 px-6 py-6">
                <div
                  className="relative rounded-3xl p-6 pt-2 border-b-[5px] border-[#00000042]"
                  style={{
                    background:
              ...
              <div className="w-1/2 px-6 py-6">
                <div
                  className="relative flex flex-col rounded-3xl h-full p-6 pt-2 border-b-[5px] border-[#00000042]"
                  style={{
                    background:
                      "linear-gradient(241.54deg, rgba(138, 187, 221, 0.2) 0%, rgba(74, 101, 119, 0.2) 100%)",
                  }}
                >
                  ...
                  <div className="grow" />
                  <div className="flex justify-between p-4 pb-0 text-[#0062A5]">
                    <button className="bg-[#fff] text-xs shadow-[0px_4px_4px_0px_#00000040] py-1.5 px-6 rounded-xl">
                      Add
                    </button>
                    <button className="bg-[#fff] text-xs shadow-[0px_4px_4px_0px_#00000040] py-1.5 px-6 rounded-xl">
                      Edit
            ...
            <div className="flex py-6 -mx-6">
              <div className="w-1/2 px-6">
                <div
                  className="relative flex flex-col rounded-3xl h-full p-2 pt-2 border-b-[5px] border-[#00000042]"
                  style={{
                    background:
                      "linear-gradient(241.54deg, rgba(138, 187, 221, 0.2) 0%, rgba(74, 101, 119, 0.2) 100%)",
                  }}
              ...
              <div className="w-1/2 px-6 -my-6 flex flex-col">
                <div className="py-6">
                  ...
                  >
                    ...
                    <div className="text-lg text-[#000] px-6 flex flex-col gap-6">
                      <div className="flex">
                        <span>
                ...
                <div className="py-6">
                  <div
                    className="relative flex flex-col rounded-3xl h-full min-h-[60px] p-2 pt-2 border-b-[5px] border-[#00000042]"
                    style={{
                      background:
                        "linear-gradient(241.54deg, rgba(138, 187, 221, 0.2) 0%, rgba(74, 101, 119, 0.2) 100%)",
                    }}
          ...
          <div className="w-1/3 px-6 py-6">
            ...
            >
              ...
              <form className="text-lg text-[#000] p-6 py-3 flex flex-col gap-5">
